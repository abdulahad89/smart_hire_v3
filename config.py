...
if LLM_PROVIDER == "google":
    MAIN_MODEL = GOOGLE_AI_MODELS["flash_20_lite"]
    SCORING_MODEL = GOOGLE_AI_MODELS["flash_20_lite"]
    CHATBOT_MODEL = GOOGLE_AI_MODELS["flash_20_lite"]
    DATA_EXTRACTION_MODEL = GOOGLE_AI_MODELS["flash_20_lite"]
